...
export default function BottomSheet({
    ...
    const handleTouchMove = (e: React.TouchEvent | React.MouseEvent) => {
        ...
        if (delta > 0 && isOpen) {
            // Apply logarithmic resistance for dragging down
            // Formula: y = limit * log(1 + x / limit)
            const limit = 100; // The maximum "visual" distance it approaches
            const resistedDelta = limit * Math.log(1 + delta / limit);
        ...
        <div
            ...
            style={{
                ...
                transform: `translateY(${isOpen
                    ...
                    : `calc(100% - 120px + ${Math.min(0, dragOffset)}px)`
                    })`
            }}
        >
            ...
            < div className="bg-black rounded-t-[2.5rem] px-6 pb-[calc(2.5rem+env(safe-area-inset-bottom))] pt-2 shadow-[0_-4px_20px_rgba(255,255,255,0.05)] border-t border-white/5 relative" >
